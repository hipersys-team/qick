...
proc create_root_design { parentCell } {
  ...
  set_property -dict [ list \
   ...
   CONFIG.CLKOUT1_PHASE_ERROR {233.531} \
  ...
  set_property -dict [ list \
   ...
   CONFIG.ADC2_Outclk_Freq {24.000} \
   ...
   CONFIG.ADC3_Outclk_Freq {24.000} \
  ...
  connect_bd_intf_net -intf_net adc0_clk_1 [get_bd_intf_ports adc0_clk] [get_bd_intf_pins usp_rf_data_converter_0/adc2_clk]
...
connect_bd_intf_net -intf_net [get_bd_intf_nets axis_clk_cnvrt_avg_0_M_AXIS] [get_bd_intf_pins axis_clk_cnvrt_avg_0/M_AXIS] [get_bd_intf_pins system_ila_1/SLOT_0_AXIS]
  ...
  connect_bd_net -net usp_rf_data_converter_0_clk_adc0 [get_bd_pins clk_adc0_x2/clk_in1] [get_bd_pins rst_adc0/slowest_sync_clk] [get_bd_pins usp_rf_data_converter_0/clk_adc2]
