...
proc create_root_design { parentCell } {
  ...
  # Create instance: axis_readout_v2_2, and set properties
  set axis_readout_v2_2 [ create_bd_cell -type ip -vlnv user.org:user:axis_readout_v2:1.0 axis_readout_v2_2 ]

  # Create instance: axis_readout_v2_3, and set properties
  set axis_readout_v2_3 [ create_bd_cell -type ip -vlnv user.org:user:axis_readout_v2:1.0 axis_readout_v2_3 ]
  ...
  # Create instance: axis_terminator_6, and set properties
  set axis_terminator_6 [ create_bd_cell -type ip -vlnv user.org:user:axis_terminator:1.0 axis_terminator_6 ]
  set_property -dict [ list \
   CONFIG.DATA_WIDTH {160} \
 ] $axis_terminator_6
  ...
  # Create instance: clk_adc1_x2, and set properties
  set clk_adc1_x2 [ create_bd_cell -type ip -vlnv xilinx.com:ip:clk_wiz:6.0 clk_adc1_x2 ]
  set_property -dict [ list \
   CONFIG.CLKOUT1_JITTER {166.482} \
   CONFIG.CLKOUT1_REQUESTED_OUT_FREQ {384} \
   CONFIG.MMCM_CLKOUT0_DIVIDE_F {3.125} \
 ] $clk_adc1_x2
  ...
  # Create instance: rst_adc1_x2, and set properties
  set rst_adc1_x2 [ create_bd_cell -type ip -vlnv xilinx.com:ip:proc_sys_reset:5.0 rst_adc1_x2 ]
  ...
  set_property -dict [ list \
   ...
   CONFIG.ADC1_Outclk_Freq {24.000} \
  ...
  connect_bd_intf_net -intf_net axis_clk_cnvrt_avg_4_M_AXIS [get_bd_intf_pins axis_clk_cnvrt_avg_2/M_AXIS] [get_bd_intf_pins axis_tproc64x32_x8_0/s3_axis]
  connect_bd_intf_net -intf_net axis_clk_cnvrt_avg_7_M_AXIS [get_bd_intf_pins axis_clk_cnvrt_avg_3/M_AXIS] [get_bd_intf_pins axis_tproc64x32_x8_0/s4_axis]
  ...
  connect_bd_intf_net -intf_net axis_readout_v2_2_m0_axis [get_bd_intf_pins axis_readout_v2_2/m0_axis] [get_bd_intf_pins axis_terminator_2/s_axis]
  connect_bd_intf_net -intf_net axis_readout_v2_2_m1_axis [get_bd_intf_pins axis_avg_buffer_2/s_axis] [get_bd_intf_pins axis_readout_v2_2/m1_axis]
  connect_bd_intf_net -intf_net axis_readout_v2_3_m0_axis [get_bd_intf_pins axis_readout_v2_3/m0_axis] [get_bd_intf_pins axis_terminator_3/s_axis]
  connect_bd_intf_net -intf_net axis_readout_v2_3_m1_axis [get_bd_intf_pins axis_avg_buffer_3/s_axis] [get_bd_intf_pins axis_readout_v2_3/m1_axis]
  ...
  connect_bd_intf_net -intf_net axis_register_slice_2_M_AXIS [get_bd_intf_pins axis_readout_v2_2/s_axis] [get_bd_intf_pins axis_register_slice_2/M_AXIS]
  connect_bd_intf_net -intf_net axis_register_slice_3_M_AXIS [get_bd_intf_pins axis_readout_v2_3/s_axis] [get_bd_intf_pins axis_register_slice_3/M_AXIS]
  connect_bd_intf_net -intf_net axis_signal_gen_v4_0_m_axis [get_bd_intf_pins axis_signal_gen_v4_0/m_axis] [get_bd_intf_pins usp_rf_data_converter_0/s10_axis]
  connect_bd_intf_net -intf_net axis_signal_gen_v4_1_m_axis [get_bd_intf_pins axis_signal_gen_v4_1/m_axis] [get_bd_intf_pins usp_rf_data_converter_0/s11_axis]
  connect_bd_intf_net -intf_net axis_signal_gen_v4_2_m_axis [get_bd_intf_pins axis_signal_gen_v4_2/m_axis] [get_bd_intf_pins usp_rf_data_converter_0/s12_axis]
  connect_bd_intf_net -intf_net axis_signal_gen_v4_3_m_axis [get_bd_intf_pins axis_signal_gen_v4_3/m_axis] [get_bd_intf_pins usp_rf_data_converter_0/s13_axis]
  ...
  connect_bd_intf_net -intf_net axis_tproc64x32_x8_0_m6_axis [get_bd_intf_pins axis_terminator_4/s_axis] [get_bd_intf_pins axis_tproc64x32_x8_0/m6_axis]
  connect_bd_intf_net -intf_net axis_tproc64x32_x8_0_m7_axis [get_bd_intf_pins axis_terminator_5/s_axis] [get_bd_intf_pins axis_tproc64x32_x8_0/m7_axis]
  connect_bd_intf_net -intf_net axis_tproc64x32_x8_0_m8_axis [get_bd_intf_pins axis_terminator_6/s_axis] [get_bd_intf_pins axis_tproc64x32_x8_0/m8_axis]
  ...
  connect_bd_intf_net -intf_net ps8_0_axi_periph_M11_AXI [get_bd_intf_pins axis_readout_v2_2/s_axi] [get_bd_intf_pins ps8_0_axi_periph/M11_AXI]
  connect_bd_intf_net -intf_net ps8_0_axi_periph_M12_AXI [get_bd_intf_pins axis_avg_buffer_2/s_axi] [get_bd_intf_pins ps8_0_axi_periph/M12_AXI]
  ...
  connect_bd_intf_net -intf_net ps8_0_axi_periph_M14_AXI [get_bd_intf_pins axis_readout_v2_3/s_axi] [get_bd_intf_pins ps8_0_axi_periph/M14_AXI]
  ...
  connect_bd_intf_net -intf_net usp_rf_data_converter_0_m10_axis [get_bd_intf_pins axis_register_slice_2/S_AXIS] [get_bd_intf_pins usp_rf_data_converter_0/m10_axis]
  connect_bd_intf_net -intf_net usp_rf_data_converter_0_m12_axis [get_bd_intf_pins axis_register_slice_3/S_AXIS] [get_bd_intf_pins usp_rf_data_converter_0/m12_axis]
  connect_bd_intf_net -intf_net usp_rf_data_converter_0_vout10 [get_bd_intf_ports vout0] [get_bd_intf_pins usp_rf_data_converter_0/vout10]
  connect_bd_intf_net -intf_net usp_rf_data_converter_0_vout11 [get_bd_intf_ports vout1] [get_bd_intf_pins usp_rf_data_converter_0/vout11]
  connect_bd_intf_net -intf_net usp_rf_data_converter_0_vout12 [get_bd_intf_ports vout2] [get_bd_intf_pins usp_rf_data_converter_0/vout12]
  connect_bd_intf_net -intf_net usp_rf_data_converter_0_vout13 [get_bd_intf_ports vout3] [get_bd_intf_pins usp_rf_data_converter_0/vout13]
  ...
  connect_bd_intf_net -intf_net vin2_1 [get_bd_intf_ports vin2] [get_bd_intf_pins usp_rf_data_converter_0/vin1_01]
  connect_bd_intf_net -intf_net vin3_1 [get_bd_intf_ports vin3] [get_bd_intf_pins usp_rf_data_converter_0/vin1_23]
  ...
  connect_bd_net -net clk_adc1_x2_clk_out1 [get_bd_pins axis_avg_buffer_2/s_axis_aclk] [get_bd_pins axis_avg_buffer_3/s_axis_aclk] [get_bd_pins axis_readout_v2_2/aclk] [get_bd_pins axis_readout_v2_3/aclk] [get_bd_pins axis_register_slice_2/aclk] [get_bd_pins axis_register_slice_3/aclk] [get_bd_pins axis_terminator_2/s_axis_aclk] [get_bd_pins axis_terminator_3/s_axis_aclk] [get_bd_pins clk_adc1_x2/clk_out1] [get_bd_pins rst_adc1_x2/slowest_sync_clk] [get_bd_pins usp_rf_data_converter_0/m1_axis_aclk]
  connect_bd_net -net clk_adc1_x2_locked [get_bd_pins clk_adc1_x2/locked] [get_bd_pins rst_adc1_x2/dcm_locked]
  ...
  connect_bd_net -net usp_rf_data_converter_0_clk_adc1 [get_bd_pins clk_adc1_x2/clk_in1] [get_bd_pins rst_adc1/slowest_sync_clk] [get_bd_pins usp_rf_data_converter_0/clk_adc1]
  connect_bd_net -net usp_rf_data_converter_0_clk_dac1 [get_bd_pins axi_bram_ctrl_0_bram/clkb] [get_bd_pins axis_clk_cnvrt_avg_0/m_axis_aclk] [get_bd_pins axis_clk_cnvrt_avg_1/m_axis_aclk] [get_bd_pins axis_clk_cnvrt_avg_2/m_axis_aclk] [get_bd_pins axis_clk_cnvrt_avg_3/m_axis_aclk] [get_bd_pins axis_set_reg_0/s_axis_aclk] [get_bd_pins axis_signal_gen_v4_0/aclk] [get_bd_pins axis_signal_gen_v4_1/aclk] [get_bd_pins axis_signal_gen_v4_2/aclk] [get_bd_pins axis_signal_gen_v4_3/aclk] [get_bd_pins axis_terminator_4/s_axis_aclk] [get_bd_pins axis_terminator_5/s_axis_aclk] [get_bd_pins axis_terminator_6/s_axis_aclk] [get_bd_pins axis_tproc64x32_x8_0/aclk] [get_bd_pins rst_dac1/slowest_sync_clk] [get_bd_pins usp_rf_data_converter_0/clk_dac1] [get_bd_pins usp_rf_data_converter_0/s1_axis_aclk]
  ...
  connect_bd_net -net vect2bits_4_0_dout12 [get_bd_pins axis_avg_buffer_0/trigger] [get_bd_pins vect2bits_4_0/dout12]
  connect_bd_net -net vect2bits_4_0_dout13 [get_bd_pins axis_avg_buffer_1/trigger] [get_bd_pins vect2bits_4_0/dout13]
  connect_bd_net -net vect2bits_4_0_dout14 [get_bd_pins axis_avg_buffer_2/trigger] [get_bd_pins vect2bits_4_0/dout14]
  connect_bd_net -net vect2bits_4_0_dout15 [get_bd_pins axis_avg_buffer_3/trigger] [get_bd_pins vect2bits_4_0/dout15]
  ...
  create_bd_addr_seg -range 0x00001000 -offset 0xA0011000 [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs axis_avg_buffer_2/s_axi/reg0] SEG_axis_avg_buffer_2_reg0
  create_bd_addr_seg -range 0x00001000 -offset 0xA0013000 [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs axis_avg_buffer_3/s_axi/reg0] SEG_axis_avg_buffer_3_reg0
  ...
  create_bd_addr_seg -range 0x00001000 -offset 0xA0010000 [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs axis_readout_v2_2/s_axi/reg0] SEG_axis_readout_v2_2_reg0
  create_bd_addr_seg -range 0x00001000 -offset 0xA0012000 [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs axis_readout_v2_3/s_axi/reg0] SEG_axis_readout_v2_3_reg0
